...
Minimal Sandcaster example — a single agent in an E2B sandbox.
...
The agent starts in a fresh E2B sandbox, responds to your prompt, and tears down the sandbox when done. This is the simplest possible Sandcaster configuration.

## Configuration

See `sandcaster.json` for the full configuration. Key settings:
- `model`: gpt5 (OpenAI gpt-5.4 — cost-efficient default)
- `systemPrompt`: basic assistant persona
